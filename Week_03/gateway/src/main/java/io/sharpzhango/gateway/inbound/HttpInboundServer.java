...
public class HttpInboundServer {
    ...
    public void run() throws Exception {
        ...
        try {
            ...
            b.option(ChannelOption.SO_BACKLOG, 128) // 处于握手状态的socket 连接数
                    .option(ChannelOption.TCP_NODELAY, true) // 将小包拼成大包（高并发时有利）网络拥堵与Nagle算法优化
                    ...
                    .option(ChannelOption.ALLOCATOR, PooledByteBufAllocator.DEFAULT); // 分配内存
